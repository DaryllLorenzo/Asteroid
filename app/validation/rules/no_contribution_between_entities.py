...
class NoContributionBetweenEntities(Rule):
    """
    No Contribution Between Entities.
    ...
    def check(self, context: dict) -> str | None:
        ...
        """
        if (
            context.get("arrow_type") == "contribution"
            and context.get("source_is_entity")
            and context.get("dest_is_entity")
        ):
            return (
                "No se puede crear un enlace Contribution entre "
...
rule = NoContributionBetweenEntities()
